...
if __name__ == '__main__':
    ...
    PATH_TO_TEST_IMAGES_DIR = r'F:\PostGraduate\DataSet\COCO'
    # TEST_IMAGE_PATHS = [os.path.join(PATH_TO_TEST_IMAGES_DIR, 'car{}'.format(6228 + i)) for i in range(1, 3)]
    TEST_IMAGE_PATHS = [520, 536, 544]
    dataType = 'val2014'
    annFile = '{}/annotations/instances_{}.json'.format(PATH_TO_TEST_IMAGES_DIR, dataType)
    FORMAT = 'coco'

    # Size, in inches, of the output images.
    IMAGE_SIZE = (12, 8)

    pipeline_config_path = 'Model\\pipeline\\pipeline_resnet50.config'
    ...
    with graph.as_default():
        ...
        save_path = r'Model\faster_rcnn_resnet50_coco_2018_01_28\faster_rcnn_resnet50_coco_2018_01_28\model.ckpt'
        ...
        with tf.Session() as sess:
            ...
            for image_path in TEST_IMAGE_PATHS:
                ...
                if FORMAT == 'txt':
                    ...
                    # rpn = [[ann['bbox'][1], ann['bbox'][0], ann['bbox'][1] + ann['bbox'][3],
                    #         ann['bbox'][0] + ann['bbox'][2]] for ann in anns]
                if random_jittle:
