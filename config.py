...
_resnet50 = {
    'config': os.path.join(__C.ROOT, 'faster_rcnn_resnet50_coco_2018_01_28/faster_rcnn_resnet50_coco_2018_01_28',
                           'pipeline.config'),
    'model': os.path.join(__C.ROOT, 'faster_rcnn_resnet50_coco_2018_01_28/faster_rcnn_resnet50_coco_2018_01_28',
                          'model.ckpt')}
_inception_v2 = {'config': os.path.join(__C.ROOT, 'faster_rcnn_inception_v2_coco_2018_01_28', 'pipeline.config'),
                 'model': os.path.join(__C.ROOT, 'faster_rcnn_inception_v2_coco_2018_01_28', 'model.ckpt')}
