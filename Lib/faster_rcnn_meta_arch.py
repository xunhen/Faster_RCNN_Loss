...
class FasterRCNNMetaArch(model.DetectionModel):
    ...
    def provide_rpn_box(self, rpn_boxes_list, rpn_objectness_predictions_with_background):
        ...
        self._rpn_objectness_predictions_with_background = rpn_objectness_predictions_with_background

    def _get_rpn_box(self):
        return self._rpn_boxes_list, self._rpn_objectness_predictions_with_background
